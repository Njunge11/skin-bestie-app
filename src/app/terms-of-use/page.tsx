        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <main className="lg:col-span-3">
            <div className="prose prose-lg max-w-none">
              ...
              <section id="introduction" className="mb-16 scroll-mt-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  <Link
                    ...
                    className="text-skinbestie-landing-pink hover:opacity-70 underline transition-opacity"
                  >
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Please ensure you read these terms and conditions of use,
                  which govern your use of and access to skinbestie.co (the
                  &quot;website&quot;), whether as a guest or a registered user.
                  If you do not accept them, please do not use the website.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  This website is owned and operated by Gentle Human Ltd
                  (referred to as &quot;Skin Bestie&quot;, &quot;we&quot;,
                  &quot;us&quot; or &quot;our&quot;). We are registered in
                  England and Wales under company number 14448690 and have our
                  registered office at Huckletree (Priory House) Limited, 6
                  Wrights Lane, London, W8 6TA
                </p>
              </section>

              {/* Medical Disclaimer */}
              <section id="medical-disclaimer" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Medical Disclaimer
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  We are not medical professionals. The information and content
                  on this website, including any product descriptions,
                  recommendations, or advice, is for informational purposes only
                  and is not intended to be a substitute for professional
              ...
              <section id="changes-terms" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Changes to these terms
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  From time to time, we may modify these Terms. Please check
                  this page from time to time to take notice of any changes we
                  make, as they are binding on you. Your use of our website
                  following any such change constitutes your agreement to follow
                  and be bound by the Terms as amended. If at any time you do
                  not wish to accept the Terms, you may not use our website.
                </p>
              </section>

              {/* Changes to our website */}
              <section id="changes-website" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Changes to our website
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  content on our website may be out of date at any given time,
                  and we are under no obligation to update it.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  We do not guarantee that our website, or any content on it,
                  will be free from errors or omissions and you accept that such
                  changes may result in your being unable to access our website.
                </p>
              </section>

              {/* Information Accuracy */}
              <section id="information-accuracy" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Information Accuracy
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  and services) is provided without warranty of any kind,
                  whether express or implied, including but not limited to,
                  implied warranties of quality, fitness for a particular
                  purpose, or non-infringement. The content on this website is
                  subject to change and update by us from time to time without
                  notification. You should periodically revisit this page to
                  review the current terms and conditions of use.
                </p>
              </section>

              {/* Jurisdiction and Local Laws */}
              <section id="jurisdiction" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Jurisdiction and Local Laws
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  The content on this website is provided in accordance with and
                  subject to the laws of England. No representations are made
                  that materials on this website are appropriate or available
                  for use in locations outside of the united kingdom. Users who
                  access this website from other locations do so on their own
                  initiative and are responsible for compliance with local laws.
                </p>
              </section>

              {/* Use of the website */}
              <section id="use-website" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Use of the website
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Our website is made available free of charge. We do not
                  guarantee that our website, or any content on it, will always
                  be available or be uninterrupted. We may need to suspend
                  access to our website at times for technical or maintenance
                  purposes. Internet and IT or telecommunication networks are
                  not error-free, and interruptions and failures can occur. We
                  cannot provide any guarantee in this regard and shall not
                  therefore be held liable for any damage that may relate to the
                  use of the Internet and IT or telecommunication networks,
                ...
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  ...
                  <li>Any external intrusions or computer viruses;</li>
                  <li>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  suspend, withdraw, discontinue or change all or any part of
                  our website without notice. We will not be liable to you if
                  for any reason our website is unavailable at any time or for
                  any period. You are responsible for making all arrangements
                  necessary for you to have access to our website. We do not
                  warrant that our website is compatible with your computer
                  equipment or that our website or its server is free of errors
                  or viruses, worms or &quot;Trojan horses&quot; and we are not
                  liable for any damage you may suffer as a result of such
                  destructive features.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  You are also responsible for ensuring that all persons who
                  access our website through your internet connection are aware
              ...
              {/* Prohibited uses */}
              <section id="prohibited-uses" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Prohibited uses
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section id="account-password" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Your account and password
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Access to the website and/or certain sections thereof may
                  require the use of PIN codes or passwords. If you choose, or
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  website and/or certain section thereof, in order to prevent
                  any fraudulent use of such codes. Please inform us of any
                  fraudulent use that you may become aware of. In the event of
                  any breach of the rules set forth under these Terms, we have
                  the right to disable any user identification code or password,
                  whether chosen by you or allocated by us, at any time, if in
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  us at team@skinbestie.co.
                </p>
              </section>

              {/* Third-Party Links */}
              <section id="third-party-links" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Third-Party Links
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  aspect of the information contained on such third-party
                  websites or websites linked to such websites and shall not be
                  liable for any loss or damage arising from your reliance upon
                  such information.
                </p>
              </section>

              {/* Internet security and privacy */}
              <section id="internet-security" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Internet security and privacy
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  including its lawfulness, truthfulness, and accuracy. You
                  should not post or send any unlawful, threatening, defamatory,
                  obscene material, or any material that could give rise to a
                  criminal offense and/or civil liability in any relevant
                  jurisdiction.
                </p>
              </section>

              {/* Copyright and Intellectual Property */}
              <section id="copyright" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Copyright and Intellectual Property
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  (including, but not limited to text, content, software,
                  database rights, video, music, sound, graphics, photographs,
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  network) the Content or any part thereof. You may not make any
                  part of our website available as part of another website,
                  whether by hyperlink framing on the internet or otherwise. Our
                  website and the information contained therein may not be used
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  contractual, statutory or common law rights of any party.
                </p>
              </section>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  views expressed by users on our website are their own and do
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  make no representations that results depicted are achievable,
                  as content may have been altered by users.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  any kind incurred by you as a result of the use of, or
                  reliance upon, any User Content transmitted, uploaded, posted,
                  e-mailed or otherwise made available via the website.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  If you wish to complain about information or materials
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  website, you must comply with the Acceptable Standards below.
                  We have the right to remove any posting you make on our site
                  if, in our opinion, your post does not comply with these
                  content standards.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  grant us, and other users of our website, a limited licence to
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  applicable legislation in force and/or to accepted standards
                  of morality and/or the Acceptable Standards set forth herein
                  and/or which infringes the rights of others, at the following
                  address: team@skinbestie.co.
                </p>
              </section>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  website, you grant SkinBestie a perpetual, irrevocable,
                  worldwide, royalty-free, fully sub-licensable and transferable
                  right and license to use, copy, modify, delete in its
                  entirety, adapt, publish, translate, create derivative works
                  from and distribute such content and/or incorporate such User
                  Content together with your username/name and location into any
                  form, medium or technology, including (but not limited to):
                </p>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li>
                  ...
                  <li>On all advertising media both online and offline;</li>
                  <li>On internal SkinBestie communications;</li>
                  <li>
                    For corporate, financial communication and public relations
                    communications and disclosures;
                  </li>
                  <li>On retailer-and client-facing media.</li>
                </ul>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Additionally, any User Content that you upload or post on the
                  site must be your own sole authorship, and you must be the
                  owner of the intellectual property rights of the content.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  You are hereby informed that said social networks are
                  platforms owned by third parties and, accordingly, the
                  circulation and use of User Content via said social networks
                  shall be governed by the terms of use defined by said third
                  parties. We can therefore not be held responsible for any use
                  of the content by us or any third parties in accordance with
                  the terms of use defined by the social networks, including
                  without limitation, in terms of the scope and duration of
                  licensed rights, and removal of the User Content. You shall be
                  responsible for handling any third-party claims relating to
                  the use of the User Content in accordance with the terms of
                  use defined by the social networks.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  In addition, we hereby remind you that any User Content may be
                  referenced on a search engine and therefore to be accessed by
                  an audience outside the website.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  This authorisation allows us to adapt your User Content in
                  order in any way we see fit including but not limited to
                  regulatory compliance purposes whilst still respecting the
                  original sentiment of the original User Content.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  and nature, known and unknown including reasonable
                  lawyers&apos; fees, arising out of a breach of your
                  representations and warranties set forth above, or your
                  violation of any law or the rights of a third party.
                </p>
              </section>

              {/* Applicable Law and Jurisdiction */}
              <section id="applicable-law" className="mb-16 scroll-mt-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Applicable Law and Jurisdiction
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  The use of this website is subject to the laws of England,
                  which shall exclusively govern the interpretation,
                  application, and effect of all the above permissions,
                  exclusions, licenses, and conditions of use. The courts of
                  England shall have exclusive jurisdiction over all claims or
                  disputes arising in relation to, out of, or in connection with
