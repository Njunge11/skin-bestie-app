    ...
    <div className="min-h-screen bg-skinbestie-landing-white">
      ...
      <div className="relative overflow-hidden bg-skinbestie-landing-blue">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg font-medium text-skinbestie-landing-pink">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <main className="lg:col-span-3 space-y-16">
            ...
            <section id="how-we-use">
              ...
              <h3
                className={`${anton.className} text-xl lg:text-2xl font-normal uppercase mb-4`}
                style={{ color: "#222118" }}
              >
              ...
              >
                ...
                <Link
                  ...
                  className="text-skinbestie-landing-pink hover:underline"
                >
            ...
            <section id="cookies">
              ...
              >
                ...
                or refer to the Help function within your browser to learn how
                to manage your settings within your browser. For more
