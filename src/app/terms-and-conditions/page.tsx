          ...
          <main className="lg:col-span-3 space-y-16">
            ...
            <section id="introduction">
              ...
              >
                ...
                before booking. By placing a booking or creating an account you
            ...
            <section id="who-we-are">
              ...
              >
                ...
                Registered office: Huckletree (Priory House) Limited, 6 Wrights
                Lane, London, W8 6TA.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
            ...
            <section id="what-we-do">
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                <strong>Medical disclaimer:</strong> We do not provide medical
                advice. All content, recommendations, and routines we provide
                are for information only and are not a substitute for
                professional medical advice, diagnosis, or treatment. Always
                seek the advice of a qualified healthcare provider with any
                questions regarding a medical condition. Never disregard or
                delay seeking professional medical advice because of something
                you hear or read via our services.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "#1B1D1F" }}
            ...
            <section id="account-eligibility">
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                To activate your subscription and booking, you must provide the
                following information (all mandatory): name, email, phone
              ...
              >
                ...
                current, and complete. You agree to update your details if they
                change.
              </p>
            </section>
            ...
            <section id="booking-payments">
              ...
              >
                ...
                confirmed once payment is received (processed by Stripe). We may
                decline a booking and will notify you if this happens.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
            ...
            <section id="changing-cancelling">
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                You may reschedule once free of charge if you give us at least
                48 hours&apos; notice. You can do this via your profile, by
                emailing team@skinbestie.co, or via WhatsApp.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "#1B1D1F" }}
              >
                If you cancel or attempt to reschedule with less than 48
                hours&apos; notice, you will be charged in full for the
                scheduled Coaching Call.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "#1B1D1F" }}
              >
                If you are more than 10 minutes late, the Coach may be unable to
                accommodate the session, and you will be charged in full. If you
                are late by less than 10 minutes, your session length may be
                reduced accordingly.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "#1B1D1F" }}
              >
                If we cancel for reasons beyond our reasonable control, we will
                notify you and refund any amounts you have paid for services not
                yet provided.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
              >
                <strong>Refunds:</strong> Where a refund is due, we will refund
                you to your original payment method within 14 days of your
                request. If you purchased services that have already begun or
                been delivered, we may deduct a reasonable amount for services
                received up to the date you told us you wished to cancel.
              </p>
            </section>
            ...
            <section id="coaching-calls">
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                <strong>Recording:</strong> We record Coaching Calls for service
                delivery, quality assurance, safeguarding, and to help prepare
                your personalised routine. Your Coach will inform you before the
                session starts. If you do not wish to be recorded, please tell
                us before your session so we can discuss alternatives (which may
                include re-booking or not proceeding).
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "#1B1D1F" }}
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                <strong>Retention & access:</strong> Recordings are stored
                securely and accessible only to authorised personnel who need
                them for the purposes above. Retention period: 90 days.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
            ...
            <section id="personalised-routines">
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                After your Coaching Call, your Coach will create a personalised
                routine based on your goals and information you share.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "#1B1D1F" }}
              >
                ...
                purchase products. Those purchases are between you and the third
                party. Please review the third party&apos;s terms, privacy
                policy, and returns policy before buying.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
              >
                We make no guarantees that any routine or product will achieve a
                particular result and we are not liable for third-party
                products.
              </p>
            </section>
            ...
            <section id="your-responsibilities">
              ...
              >
                ...
                unlawfully, or in a way that risks harm to you, our Coaches, or
                others.
              </p>
            </section>
            ...
            <section id="intellectual-property">
              ...
              >
                ...
                non-exclusive, non-transferable licence to use your personalised
                routine and any materials we provide for your personal use only.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
              >
                You must not copy, distribute, resell, or make commercial use of
                our materials without our prior written consent.
              </p>
            </section>
            ...
            <section id="communications">
              ...
              <p
                ...
                style={{ color: "#1B1D1F" }}
              >
                <strong>Marketing:</strong> We only send promotional
                emails/SMS/WhatsApp messages if you opt in. You can withdraw
                consent at any time via the unsubscribe link or by contacting
                us. Service-related messages will still be sent where necessary.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
            ...
            <section id="our-responsibility">
              ...
              >
                ...
                business losses (including loss of profit, business, goodwill),
                or losses caused by third-party products or websites.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "#1B1D1F" }}
              >
                Subject to the above, our total liability for any claims arising
                out of or in connection with the services will be limited to the
                amount you paid for the Coaching Call giving rise to the claim.
              </p>
            </section>
            ...
            <section id="events-outside-control">
              ...
              >
                ...
                beyond our reasonable control (for example, internet outages,
                platform downtime, illness, or changes in law). If such an event
                affects your booking, we will contact you and either reschedule
                or refund amounts paid for services not yet provided.
              </p>
            </section>
            ...
            <section id="personal-data">
              ...
              >
                ...
                for details on how we collect and use your personal
                data—including data shared during Coaching Calls and any
                recordings—and how to contact us at privacy@skinbestie.co to
            ...
            <section id="governing-law">
              ...
              >
                ...
                proceedings in the English courts. If you live in Scotland or
                Northern Ireland, you can bring legal proceedings in your local
                courts.
              </p>
            </section>
