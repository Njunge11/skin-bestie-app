...
//   return (
//     <section className=" bg-[#FFFDF2] flex items-center justify-center p-2">
    ...
    <section className="min-h-[560px] xl:h-[695px] w-full bg-[#FFFDF2]">
      ...
      <div className="h-full w-full flex items-center justify-center px-2">
        <div className="w-full max-w-7xl">
          ...
          <div className="mt-2 sm:mt-6 flex flex-col lg:flex-row border-[0.4px] border-[#959170] rounded-lg overflow-hidden bg-[#FFFBE7]">
            {/* Image */}
            <div className="relative bg-gray-50 w-full lg:w-[416px] lg:h-[395px] flex-shrink-0">
              <div className="aspect-[416/395] lg:aspect-auto lg:h-full">
                <img
            ...
            {/* 2×2 grid */}
            <div className="flex-1 flex flex-col lg:grid lg:grid-cols-2 lg:grid-rows-2 lg:h-[395px]">
              {cells.map((item, i) => (
                <div key={i} className={borderByIndex[i]}>
                  {item ? (
                    <>
