        ...
        {useSwitch ? (
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              {/* Toggle Switch */}
              <div className="relative inline-flex items-center bg-gray-900 rounded-full p-0.5 gap-0.5">
                {/* Sun Icon Button */}
                <button
                  onClick={() => setActiveTab("morning")}
                  className={cn(
                    "relative z-10 flex items-center justify-center w-9 h-9 rounded-full transition-all",
                    activeTab === "morning"
